...
import 'package:soccerapp/core/controllers/ycard_controller.dart';
import 'package:soccerapp/core/models/data/asist_data.dart';
import 'package:soccerapp/ui/theme/app_theme.dart';

class YcardScreen extends StatelessWidget {
  const YcardScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<YCardController>(
      init: Get.put(YCardController()),
      builder: (controller) {
        return Container(
